...
/**
 * Parse expression in infix form into tokens to be processed with shunting yard algoritm
 * @param {string} exp 
 * @returns 
 */
...
/**
 * Evaluate the next state of the current evaluator FA for syntax checking
 */
...
/**
 * Evaluate all operators with greater precedence than the token operator in the operator stack
 * @param {Stack<number>} valueStack 
 * @param {Stack<string>} opStack 
 * @param {string} token 
 */
